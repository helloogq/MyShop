...
<head>
    ...
    <link rel="stylesheet" href="/static/admin/dist/css/adminlte.css"><!--end::Required Plugin(AdminLTE)-->
                ...
                <form action="/login" method="post">
                    <div class="input-group mb-1">
                        <div class="form-floating">
                            <input id="loginEmail" type="text" class="form-control" value="" placeholder="">
                            <label for="loginEmail">Account</label>
                        </div>
